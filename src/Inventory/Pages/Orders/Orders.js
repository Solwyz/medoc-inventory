...
function Orders() {
  ...
  const orders = [
    { id: 1, orderId: "652542", date: "17 Jan, 2025", items: "02", amount: "AED 240", payment: "COD", invoice: "CT/12/2544", status: "Complete" },
    { id: 2, orderId: "652543", date: "18 Jan, 2025", items: "03", amount: "AED 360", payment: "Online", invoice: "CT/12/2545", status: "Ongoing" },
    { id: 3, orderId: "652544", date: "19 Jan, 2025", items: "01", amount: "AED 120", payment: "Card", invoice: "CT/12/2546", status: "Pending" },
  ];
            ...
            <div className="mt-4">
              <table className="w-full bg-white mt-4 border">
                <thead className="bg-[#F0F0F0] px-6 py-4">
                  <tr>
                    <th className="p-4 font-medium text-center text-sm flex items-center">
                      <img
                ...
                <tbody>
                  {orders.map(({ id, orderId, date, items, amount, payment, invoice, status }) => (
                    <tr key={id}>
                      <td className="p-4 font-medium text-center text-sm flex items-center">
                      ...
                      <td className="p-4 font-medium text-center text-sm">{invoice}</td>
